#define VERSION "FocusBuddy V0.210719 by keithrickard@hotmail.com"
...
#define LED_GND       10
#define LED           9
#define A1A           6         // HIGH: tip is +ve
#define A1B           5         // HIGH: tip is -ve
#define JMPR          2
#define BTN2          A2
#define BTN2_GND      A3
#define BTN1          A4
...
void setup() {
  ...
  pinMode(A1A,      OUTPUT);
  pinMode(A1B,      OUTPUT);
  pinMode(JMPR,     INPUT_PULLUP);
  pinMode(BTN1,     INPUT_PULLUP);
  pinMode(BTN1_GND, OUTPUT);
  pinMode(BTN2,     INPUT_PULLUP);
  pinMode(BTN2_GND, OUTPUT);
  
  analogWrite(LED,       LED_DIM);
  digitalWrite(LED_GND,  LOW);
  digitalWrite(A1A,      LOW);
  digitalWrite(A1B,      LOW);
  digitalWrite(BTN1_GND, LOW);
...
void focuser(byte action) {
  ...
  digitalWrite(A1A, LOW);                                   // Otherwise stop the motor
...
void help() {
  ...
  textPrint(F("V   : Get FocusBuddy Verion"));
...
/* ==============================================================================================
  ...
  ================
      ...
      BT_STAT D13 o       o D12   BT_RXD
              ...
              A1  o       o D8    -
    BTN1      A2  o       o D7    -
    BTN1_GND  A3  o       o D6~   A-1A
    BTN2      A4  o       o D5~   A-1B
    BTN2_GND  A5  o       o D4
              A6  o       o D3
              A7  o       o D2    JMPR\
              5V  o  ICSP o GND   JMPR/
              RST o  ooo  o RST
    GND       GND o 1ooo  o RX0
    +9V       VIN o       o TX1
                  +-------+
